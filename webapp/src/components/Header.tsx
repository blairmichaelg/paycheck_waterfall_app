...
export default function Header({ lastAllocation, theme, onToggleTheme }: HeaderProps) {
  ...
  return (
    <header style={{ marginBottom: 24, textAlign: 'center', position: 'relative' }}>
      ...
      <p style={{ margin: 0, color: colors.textSecondary, fontSize: 14, marginBottom: 16 }}>Your guilt-free spending companion</p>
      ...
      {hasAllocation && (
        <div style={{ 
          ...
          <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.8)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.5px' }}>
            💚 Guilt-Free Spending
          </div>
